            ...
            <div class="content">
                <div class="container">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            <h6 class="card-title">Kami menyediakan bunga-bunga yang akan mempercantik taman atau
                                halaman rumah Anda</h6>

                            <p class="card-text">
                            </p>
                            <a href="{{ route('belanja') }}" class="btn btn-primary">Ayo Belanja</a>
